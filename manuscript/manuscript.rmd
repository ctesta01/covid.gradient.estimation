...
[@donovan_us_2022], and facing uncertain prospects for the third COVID-19 winter
...
[@office_of_the_commissioner_coronavirus_2022]. Despite the updated bivalent
...
became available [@bendix_less_2022; @lambert_most_2022]. As such, and with an
enduring history of inequities in health care access in the US
[@ortega_ending_2021; @blendon_inequities_2002; @bailey_how_2021;
...
knitr::include_graphics(here("manuscript/figures/county_trends_by_division.png"))
```
...
[@kim_covid-19_2020]. Kim, Marrast, and Conigliaro noted at least three structural
...
healthcare they deserve [@okonkwo_covid-19_2021]. Even though stay-at-home orders
designed to mitigate spread that were prevalent in many states
[@moreland_timing_2020], workers functioning in capacities essential to the
...
[@national_conference_of_state_legislatures_covid-19_2021; @wei_risk_2022;
@national_bureau_of_economic_research_measuring_2021; @the_lancet_plight_2020;
@hanage_covid-19_2020]. It's clear that those with more
...
for any strictly parametric model components, $\mathbf \theta$ is the corresponding
...
knitr::include_graphics(here("manuscript/figures/gam_demo_figure.png"))
```
...
date, d=c(1,1))` and dropping the `s(median_age)` term which otherwise becomes redundant. 
...
knitr::include_graphics(here("manuscript/figures/nonspatial_panel_figure.png"))
```
...
knitr::include_graphics(here("manuscript/figures/ICEraceinc_age_panel_figure.png"))
```
...
knitr::include_graphics(here("manuscript/figures/side_by_side_crude_and_smoothed.png"))
```
...
knitr::include_graphics(here("manuscript/figures/temporal_panel_figure.png"))
```
...
```{r neighboring-graph-morans-i, fig.cap = "The spatial autocorrelation of COVID-19 rates in January 2022. Panel A shows the graph of US counties connected according to which are neighbors. Panel B shows a scatterplot depicting each US counties' COVID-19 mortality rate (x-axis) compared to the average of its neighbors' COVID-19 mortality rates (y-axis). A regression line shows the association between counties' COVID-19 rates and their neighboring counties' COVID-19 mortality rates.  Dotted lines indicated the average for US county-level crude COVID-19 mortality rates (vertical) and for the average of each counties' neighboring counties' COVID-19 mortality rates (horizontal)."}
# knitr::include_graphics(here("analysis/08_spatiotemporal_autocorrelation/county_network_and_morans_plot.png"))
knitr::include_graphics(here("manuscript/figures/county_network_and_morans_plot.png"))
```

```{r temporal-acf, fig.cap = "The median (black) and quantiles (shaded bands) of temporal autocorrelation of counties' COVID-19 mortality rates over time during April 2020 — August 2022.", out.width = '50%', fig.align='center'}
# knitr::include_graphics(here("analysis/08_spatiotemporal_autocorrelation/temporal_acf.png"))
knitr::include_graphics(here("manuscript/figures/temporal_acf.png"))
```
...
knitr::include_graphics(here("manuscript/figures/spatiotemporal_panel_figure.png"))
```
...
the contexts in which people exist [@testa_public_2022].
